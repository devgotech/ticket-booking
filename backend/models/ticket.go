...
type Ticket struct {
	...
	UserID    uint      `json:"userId" gorm:"foreignkey:UserID;constraint:OneUpdate:CASCADE,OnDelete:CASCADE;"`
	Event     Event     `json:"event" gorm:"foreignkey:EventID;constraint:OneUpdate:CASCADE,OnDelete:CASCADE;"`
